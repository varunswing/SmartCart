			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${!empty pageContext.request.userPrincipal.name}">
					<li><a href="<c:url value="/index1" />"><span
							class="glyphicon glyphicon-smart-user"></span>Welcome..${pageContext.request.userPrincipal.name}</a></li>

					<security:authorize access="hasRole('ROLE_USER')">
						<li><a href="<c:url value="/cart/getCartById" />"><span
								class="glyphicon glyphicon-smart-cart"></span> Cart</a></li>
					</security:authorize>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${pageContext.request.userPrincipal.name==null}">
					<li><a href="<c:url value="/login" />"><span
							class="glyphicon glyphicon-smart-cart"></span>My Cart</a></li>
